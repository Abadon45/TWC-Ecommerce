$(document).ready(function () {
    ...
    function populateProvinces(data) {
        ...
        provinceDropdown.off('change.address').on('change.address', function () {
    ...
    function populateCities(cities) {
        ...
        cityDropdown.off('change.address').on('change.address', function () {
        ...
        $(".city-dropdown").off('click.address').on('click.address', function () {
            $(".cityInputBox").hide();
            $(".cityDropdownBox").show();
            $(".cityDropdown").attr("name", "city");
            $(".cityInputBox input")
        ...
        cityDropdown.on('change.address', function () {
            const selectedCity = $(this).val();
    ...
    function populateBarangays(barangays) {
        ...
        barangayDropdown.off('change.address').on('change.address', function () {
        ...
        $(".barangay-dropdown").off('click.address').on('click.address', function () {
            $(".barangayInputBox").hide();
            $(".barangayDropdownBox").show();
            $(".barangayDropdown").attr("name", "barangay");
            $(".barangayInputBox input")
